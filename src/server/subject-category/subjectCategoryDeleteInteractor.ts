...
import { ISubjectCategoryDeleteOutput } from './ISubjectCategoryDeleteOutput';
import { ISubjectCategoryRepository } from './ISubjectCategoryRepository';

interface ISubjectCategoryDeleteInteractorParams extends IInteractorParams<
	ISubjectCategoryRepository,
	ISubjectCategoryDeleteInput,
	ISubjectCategory
> {
	userRepository: IUserRepository;
}

export const subjectCategoryDeleteInteractor = async (params: ISubjectCategoryDeleteInteractorParams): Promise<ISubjectCategoryDeleteOutput> => {
	...
	const output: ISubjectCategoryDeleteOutput = {};
